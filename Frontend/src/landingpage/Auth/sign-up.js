...
const SignUp = () => {
   ...
   const onRegister=async(e)=>{
      ...
      if(data.email===''||data.password===''||data.firstName===''||data.lastName===''||data.password===''||data.phone===''||confirmPassword==='')
      {
                             ...
                             {successMessage && <div className="alert alert-success text-center" role="alert">{successMessage}</div>}
                              <Form >
                                 <Row >
                                    <Col lg="6" >
                                       <Form.Group className="form-group">
                                          <Form.Label htmlFor="firstName" className="">Fisrt Name</Form.Label>
                                          <Form.Control type="text" className="" id="fisrtName"  value={data.firstName}
                                          onChange={(e)=>setData({...data,firstName:e.target.value})} onFocus={()=>setError('')}/>
                                       </Form.Group>
                                    </Col>
                                    <Col lg="6">
                                       <Form.Group className="form-group">
                                          <Form.Label htmlFor="lastName" className="">Last Name</Form.Label>
                                          <Form.Control type="text" className="" id="lastName" value={data.lastName} 
                                          
                                          onChange={(e)=>setData({...data,lastName:e.target.value})} onFocus={()=>setError('')}/>
                                       </Form.Group>
                                    </Col>
                                    <Col lg="6">
                                       <Form.Group className="form-group">
                                          <Form.Label htmlFor="email" className="">Email</Form.Label>
                                          <Form.Control type="email" className="" id="email"  value={data.email}
                                    ...
                                    <Col lg="6">
                                       <Form.Group className="form-group">
                                          ...
                                          <Form.Control type="text" className="" id="phone" value={data.phone}
                                          onChange={(e)=>setData({...data,phone:e.target.value})} onFocus={()=>setError('')}/>
                                       </Form.Group>
                                    </Col>
                                    <Col lg="6">
                                       <Form.Group className="form-group">
                                          <Form.Label htmlFor="password" className="">Password</Form.Label>
                                          <Form.Control type="password" className="" id="password"  value={data.password}
                                    ...
                                    <Col lg="6">
                                       <Form.Group className="form-group">
                                          ...
                                          <Form.Control type="password" className="" id="confirm-password" value={confirmPassword} onFocus={()=>setError('')}
                                 ...
                                 <div className="d-flex justify-content-center">
                                    <Button onClick={onRegister} type="button" variant="primary">Sign Up</Button>
                                 </div>
