       ...
       <>
            <Accordion as="ul" className="navbar-nav iq-main-menu" >
                ...
                <li className="nav-item" style={{marginRight:"0px"}}>
                    <Link className={`${location.pathname === '/dashboardCustomer' ? 'active' : ''} nav-link `} aria-current="page" to="/dashboardCustomer" onClick={() => {}}>
                        <i className="icon">
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav" style={{marginRight:"0px"}}>
                            <li className="nav-item">
                                <Link className={`${location.pathname === 'user-profileClient' ? 'active' : ''} nav-link`} to="user-profileClient">
                                    <i className="icon">
                    ...
                    <Accordion.Collapse eventKey="sidebar-special" >
                        <ul className="sub-nav" style={{marginRight:"0px"}}>
                            <li className="nav-item">
                                ...
                                <Link className={`${location.pathname === 'calendarClient' ? 'active' : ''} nav-link`} to="calendarClient">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="sidebar-feedBack" bsPrefix="nav-item mb-5" style={{marginRight:"0px"}}>
                <CustomToggle eventKey="sidebar-feedBack" onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-feedBack">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === 'feedBack' ? 'active' : ''} nav-link`} to="feedBack">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
...
export default VerticalNavCustomer;
