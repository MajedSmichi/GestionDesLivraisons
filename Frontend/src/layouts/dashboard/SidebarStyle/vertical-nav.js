            ...
            <Accordion as="ul" className="navbar-nav iq-main-menu" >
                ...
                <Accordion.Item as="li" eventKey="sidebar-user1" bsPrefix="nav-item" style={{marginRight:"0px"}}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-user1">
                        <ul className="sub-nav" style={{marginRight:"0px"}}>
                            <li className="nav-item">
                                <Link className={`${location.pathname === 'addAgent' ? 'active' : ''} nav-link`} to="addAgent">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === 'user-listAgent' ? 'active' : ''} nav-link`} to="user-listAgent">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="sidebar-user2" bsPrefix="nav-item" style={{marginRight:"0px"}}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-user2">
                        <ul className="sub-nav" style={{marginRight:"0px"}}>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === 'user-list' ? 'active' : ''} nav-link`} to="user-list">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <Accordion.Collapse eventKey="sidebar-special" >
                        <ul className="sub-nav" style={{marginRight:"0px"}}>
                            <li className="nav-item">
                                ...
                                <Link className={`${location.pathname === 'calendar' ? 'active' : ''} nav-link`} to="calendar">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="sidebar-feedBack" bsPrefix="nav-item mb-5" style={{marginRight:"0px",disabled:"flase"}}>
                <CustomToggle eventKey="sidebar-feedBack" onClick={(activeKey) => setActiveMenu(activeKey)}>
                    <i ><VscFeedback size={20}/></i>
                    ...
                    <Accordion.Collapse eventKey="sidebar-feedBack">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === 'AdminFeedBackList' ? 'active' : ''} nav-link`} to="AdminFeedBackList">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
