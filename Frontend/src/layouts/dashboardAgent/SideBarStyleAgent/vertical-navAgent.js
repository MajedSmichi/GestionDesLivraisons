    ...
    <>
      <Accordion as="ul" className="navbar-nav iq-main-menu">
        ...
        <li className="nav-item" style={{ marginRight: "0px" }}>
          <Link
            className={`${
              location.pathname === "/dashboardAgent" ? "active" : ""
            } nav-link `}
            aria-current="page"
            to="/dashboardAgent"
            onClick={() => {}}
          ...
          <Accordion.Collapse eventKey="sidebar-user">
            <ul className="sub-nav" style={{ marginRight: "0px" }}>
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "user-profileAgent" ? "active" : ""
                  } nav-link`}
                  to="user-profileAgent"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <Accordion.Collapse eventKey="sidebar-demands">
              <ul className="sub-nav" style={{ marginRight: "0px" }}>
                <li className="nav-item">
                  <Link
                    className={`${
                      location.pathname === "demandAgent" ? "active" : ""
                    } nav-link`}
                    to="demandAgent"
                  >
                    <i className="icon">
            ...
            <Accordion.Collapse eventKey="sidebar-maps">
              <ul className="sub-nav">
                <li className="nav-item">
                  <Link
                    className={`${
                      location.pathname === "mapAgent" ? "active" : ""
                    } nav-link`}
                    to="mapAgent"
                  >
                    <i className="icon">
          ...
          <Accordion.Collapse eventKey="sidebar-special">
            <ul className="sub-nav" style={{ marginRight: "0px" }}>
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "calendarAgent" ? "active" : ""
                  } nav-link`}
                  to="calendarAgent"
                >
                  <i className="icon">
            ...
            <Accordion.Collapse eventKey="sidebar-feedBack">
              <ul className="sub-nav">
                <li className="nav-item">
                  <Link
                    className={`${
                      location.pathname === "FeedBackList" ? "active" : ""
                    } nav-link`}
                    to="FeedBackList"
                  >
                    <i className="icon">
