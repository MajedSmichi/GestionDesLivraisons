       ...
       <>
            <Accordion as="ul" className="navbar-nav iq-main-menu" >
                ...
                <li className="nav-item" style={{marginRight:"0px"}}>
                    <Link className={`${location.pathname === '/dashboardAgent' ? 'active' : ''} nav-link `} aria-current="page" to="/dashboardAgent" onClick={() => {}}>
                        <i className="icon">
                ...
                <li style={{marginRight:"0px"}}className="nav-item static-item">
                    <Link className="nav-link static-item disabled" to="#" tabIndex="-1">
                ...
                <Accordion.Item as="li" eventKey="sidebar-user" bsPrefix="nav-item" style={{marginRight:"0px"}}>
                    <CustomToggle eventKey="sidebar-user" onClick={(activeKey) => setActiveMenu(activeKey)}>
                        ...
                        <span className="item-name">Agent</span>
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav" style={{marginRight:"0px"}}>
                            <li className="nav-item">
                                <Link className={`${location.pathname === 'user-profileAgent' ? 'active' : ''} nav-link`} to="user-profileAgent">
                                    <i className="icon">
                ...
                <Accordion.Item as="li" eventKey="sidebar-demands" bsPrefix="nav-item" style={{marginRight:"0px"}}>
                    <CustomToggle eventKey="sidebar-demands" onClick={(activeKey) => setActiveMenu(activeKey)}>
                    <i className="icon">
                           <TbFileDescription size={20}/>
                        </i>
                        <span className="item-name">Demands</span>
                        <i className="right-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <Accordion.Collapse eventKey="sidebar-demands">
                        <ul className="sub-nav" style={{marginRight:"0px"}}>
                            <li className="nav-item">
                                <Link className={`${location.pathname === 'demandAgent' ? 'active' : ''} nav-link`} to="demandAgent">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span className="item-name">Demands List</span>
                                </Link>
                            </li>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="sidebar-maps" bsPrefix="nav-item" style={{marginRight:"0px"}}>
                <CustomToggle eventKey="sidebar-maps" active={activeMenu === 'sidebar-maps' ? true : false} onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-maps">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === 'mapAgent' ? 'active' : ''} nav-link`} to="mapAgent">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <Accordion.Collapse eventKey="sidebar-special" >
                        <ul className="sub-nav" style={{marginRight:"0px"}}>
                            <li className="nav-item">
                                ...
                                <Link className={`${location.pathname === 'calendarAgent' ? 'active' : ''} nav-link`} to="calendarAgent">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="sidebar-icons" bsPrefix="nav-item mb-5" style={{marginRight:"0px"}}>
                <CustomToggle eventKey="sidebar-icons" onClick={(activeKey) => setActiveMenu(activeKey)}>
                        ...
                        <span className="item-name">Feed Back</span>
                        <i className="right-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                            </svg>
...
export default VerticalNavAgent;
