    ...
    return (
       <>
            <Accordion as="ul" className="navbar-nav iq-main-menu" >
                ...
                <Accordion.Item as="li" eventKey="horizontal-menu" bsPrefix="nav-item"style={{marginRight:"0px"}} >
                ...
                <li style={{marginRight:"0px"}}><hr className="hr-horizontal"/></li>
                ...
                <Accordion.Item as="li" eventKey="utilities-error" bsPrefix="nav-item" style={{marginRight:"0px"}}>
                ...
                <Accordion.Item as="li" eventKey="sidebar-table" bsPrefix="nav-item" style={{marginRight:"0px"}}>
